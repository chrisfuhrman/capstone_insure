...
@stop
					...
					<li>
						<a class="btn" href="ui-sliders-progress.html#">
							<i class="fa fa-wrench"></i>
						</a>
					</li>
					<!-- start: User Dropdown -->
					<li class="dropdown">
						<a class="btn account dropdown-toggle" data-toggle="dropdown" href="ui-sliders-progress.html#">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="ui-sliders-progress.html#"><i class="fa fa-user"></i> Profile</a></li>
							<li><a href="ui-sliders-progress.html#"><i class="fa fa-cog"></i> Settings</a></li>
							<li><a href="ui-sliders-progress.html#"><i class="fa fa-envelope"></i> Messages</a></li>
		...
		<div class="row">
			...
			<div id="sidebar-left" class="col-lg-2 col-sm-1">
				...
				<div class="nav-collapse sidebar-nav collapse navbar-collapse bs-navbar-collapse">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="ui-sliders-progress.html#"><i class="fa fa-eye"></i><span class="hidden-sm"> UI Features</span> <span class="label">3</span></a>
							<ul>
						...
						<li>
							<a class="dropmenu" href="ui-sliders-progress.html#"><i class="fa fa-folder-o"></i><span class="hidden-sm"> Example Pages</span> <span class="label">3</span></a>
							<ul>
						...
						<li>
							<a class="dropmenu" href="ui-sliders-progress.html#"><i class="fa fa-edit"></i><span class="hidden-sm"> Forms</span> <span class="label">3</span></a>
							<ul>
						...
						<li>
							<a class="dropmenu" href="ui-sliders-progress.html#"><i class="fa fa-list-alt"></i><span class="hidden-sm"> Charts</span> <span class="label">3</span></a>
							<ul>
						...
						<li>
							<a class="dropmenu" href="ui-sliders-progress.html#"><i class="fa fa-star"></i><span class="hidden-sm"> Icons</span> <span class="label">5</span></a>
							<ul>
				...
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header">
							<h2><i class="fa fa-tasks"></i>Sliders</h2>
						</div>
			...
			<div class="row">	
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header">
							<h2><i class="fa fa-tasks"></i>Sliders - Small</h2>
						</div>
						<div class="box-content">
							<table class="table">
								<tr>
									<td>basic</td>
									<td>
										<div class="slider small sliderSimple"></div>
									</td>
								</tr>
								<tr>
									<td>Minimum</td>
									<td>
										<div class="slider small sliderMin sliderGreen"></div>
										<div class="field_notice">Min: <span class="must sliderMinLabel">$180</span></div>
									</td>
								</tr>
								<tr>
									<td>Maximum</td>
									<td>
										<div class="slider small sliderMax sliderYellow"></div>
										<div class="field_notice">Max: <span class="must sliderMaxLabel">$280</span></div>
									</td>
								</tr>
								<tr>
									<td>Range</td>
									<td>
										<div class="slider small sliderRange sliderBlue"></div>
										<div class="field_notice">Price Range: <span class="must sliderRangeLabel">$192 - $470</span></div>
									</td>
								</tr>
								<tr>
									<td>Equalizer</td>
									<td>
										<div id="sliderVertical-1s" class="sliderBlue sliderVertical small"></div>
										<div id="sliderVertical-2s" class="sliderBlue sliderVertical small"></div>
										<div id="sliderVertical-3s" class="sliderBlue sliderVertical small"></div>
										<div id="sliderVertical-4s" class="sliderBlue sliderVertical small"></div>
										<div id="sliderVertical-5s" class="sliderBlue sliderVertical small"></div>
										<div id="sliderVertical-6s" class="sliderBlue sliderVertical small"></div>
										<div id="sliderVertical-7s" class="sliderGreen sliderVertical small"></div>
										<div id="sliderVertical-8s" class="sliderGreen sliderVertical small"></div>
										<div id="sliderVertical-9s" class="sliderYellow sliderVertical small"></div>
										<div id="sliderVertical-10s" class="sliderYellow sliderVertical small"></div>
										<div id="sliderVertical-11s" class="sliderRed sliderVertical small"></div>
										<div id="sliderVertical-12s" class="sliderRed sliderVertical small"></div>
									</td>
								</tr>
								<tr>
									<td>Blue</td>
									<td>
										<div class="slider small sliderMin-1 sliderBlue"></div>
									</td>
								</tr>
								<tr>
									<td>Green</td>
									<td>
										<div class="slider small sliderMin-2 sliderGreen"></div>
									</td>
								</tr>
								<tr>
									<td>Dark Pink</td>
									<td>
										<div class="slider small sliderMin-3 sliderPink"></div>
									</td>
								</tr>
								<tr>
									<td>Red</td>
									<td>
										<div class="slider small sliderMin-4 sliderRed"></div>
									</td>
								</tr>
								<tr>
									<td>Yellow</td>
									<td>
										<div class="slider small sliderMin-5 sliderYellow"></div>
									</td>
								</tr>
								<tr>
									<td>Dark Green</td>
									<td>
										<div class="slider small sliderMin-6 sliderDarkGreen"></div>
									</td>
								</tr>
								<tr>
									<td>Light Orange</td>
									<td>
										<div class="slider small sliderMin-7 sliderLightOrange"></div>
									</td>
								</tr>
								<tr>
									<td>Orange</td>
									<td>
										<div class="slider small sliderMin-8 sliderOrange"></div>
									</td>
								</tr>
							</table>
						</div>	
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header">
							<h2><i class="fa fa-tasks"></i>Progress Bars</h2>
						</div>
						<div class="box-content">
							<table class="table">
								<tr>
			...
			<div class="row">	
				<div class="col-lg-12">
					<div class="box">
						<div class="box-header">
							<h2><i class="fa fa-tasks"></i>Standard Progress Bars</h2>
							<div class="box-icon">
								<a href="ui-sliders-progress.html#" class="btn-setting"><i class="fa fa-wrench"></i></a>
